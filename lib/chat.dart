...
import 'package:messaaging/const.dart';
import 'package:messaaging/widget/full_photo.dart';
import 'package:messaaging/widget/loading.dart';
        ...
        children: <Widget>[
          ...
          Material(
            child: Container(
              ...
              child: IconButton(
                icon: Icon(CupertinoIcons.arrowtriangle_right_circle_fill, color: CupertinoColors.activeBlue,size: 30,),
